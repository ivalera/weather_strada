export const UI_ELEMENTS = {
    WEATHER_FROM : document.querySelector('.weather__form'),
    CITY_INPUT : document.querySelector('.weather__city'),
    ...
    LOCATION_SUNRISE : document.querySelector('.weather__sunrise'),
    LOCATION_SUNSET : document.querySelector('.weather__sunset'),
    WATHER_INTIME_LIST : document.querySelector('.weather__intime-list')
}
